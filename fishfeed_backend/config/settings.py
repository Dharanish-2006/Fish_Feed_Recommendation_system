...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@fishfeed.com')

ML_MODELS_PATH = BASE_DIR / 'ml' / 'models'
ML_DATA_PATH = BASE_DIR / 'ml' / 'data'
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Fish Feed Recommendation API',
    'DESCRIPTION': 'API for recommending optimal fish feed based on species and farming conditions.',
    'VERSION': '1.0.0',
